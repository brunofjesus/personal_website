<p>My name is <span class="text-bold"> Bruno Jesus</span>,
    I'm a software developer currently working for <a href="https://vwds.pt/man.html" class="text-marker-pink">Volkswagen
        Digital Solutions @ MAN Digital Hub</a>.</p>
<p>I hope some of my <a href="<?= BASE_URL; ?>index.php/blog" class="text-marker-orange">notes</a> are useful to you, if
    ...
    some suggestions or want to work with me please feel free to <a href="mailto:bruno.fl.jesus@gmail.com"
                                                                    class="text-marker-blue">contact me</a>.</p>
...
<div class="timeline">
    <div class="item">
        ...
        <div class="job-meta">
            ...
            <div class="time">2020-03 / Present</div>
        </div>
        <div class="job-desc"> Working at Volkswagen Digital Solutions - MAN Digital Hub</div>
    </div>
...
<div class="skills">
    <div class="skill text-center">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
             aria-hidden="true" focusable="false" width="160px" height="160px"
